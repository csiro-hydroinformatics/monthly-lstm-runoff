...
There are various options to set up a suotable python environment to run . This document outlines using conda. If you do not have any preexisting environments, we recommend you use [mambaforge](https://github.com/conda-forge/miniforge#mambaforge).
